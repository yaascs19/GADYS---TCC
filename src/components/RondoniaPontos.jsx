...
const config = {
  ...
  pontos: [
    ...
    { id: 'cultura-indigena-rondonia', nome: 'Aldeia Indígena Igarapé Lage', cidade: 'Guajará-Mirim - RO', categoria: 'Lugar Paradísíaco', descricao: 'Visita guiada à aldeia dos povos Oro Wari, com artesanato, danças tradicionais e a oportunidade de conhecer a cultura milenar dos povos originários de Rondônia.', imagem: '/images/geral/amazonas3.1.jpg', rota: null },
