  ...
  return (
    <div style={styles.page}>
      ...
      <main>
        <section style={styles.hero}>
          ...
          <div style={styles.heroContent}>
            <h1 style={styles.h1}>Espírito Santo: Terra, Mar e Montanha</h1>
            <p style={styles.heroP}>Um estado de contrastes deslumbrantes, onde praias paradisíacas encontram montanhas cobertas de Mata Atlântica e uma cultura rica em tradições italianas, alemãs e indígenas.</p>
          </div>
        </section>
        ...
        <section style={styles.featureSection} className="feature-section-animate">
          ...
          <div style={styles.featureText}>
            ...
            <p style={styles.pWithBorder}>O litoral capixaba é um dos mais belos do Brasil. De Guarapari, com suas areias radioativas e águas mornas, a Anchieta e Piúma, passando pelas praias selvagens de Regência e Conceição da Barra, o Espírito Santo oferece mais de 400 km de costa para explorar.</p>
          </div>
        </section>
        ...
        <section style={{...styles.featureSection, flexDirection: 'row-reverse'}} className="feature-section-animate">
          ...
          <div style={styles.featureText}>
            ...
            <p style={styles.pWithBorder}>A Serra Capixaba guarda cidades encantadoras como Domingos Martins, Santa Teresa e Venda Nova do Imigrante, com forte influência italiana e alemã. O Parque Estadual da Pedra Azul, com sua formação rochosa única, é um dos cartões-postais do estado.</p>
          </div>
        </section>
        ...
        <section style={styles.featureSection} className="feature-section-animate">
          ...
          <div style={styles.featureText}>
            ...
            <p style={styles.pWithBorder}>A culinária capixaba é única no Brasil. A moqueca capixaba, feita em panela de barro sem leite de coco, a torta capixaba da Semana Santa e o pirão de peixe são pratos que expressam a identidade de um povo ligado ao mar e à terra.</p>
          </div>
        </section>

        <section style={styles.ctaContainer}>
          <button style={styles.ctaButton} onClick={() => navigate('/es-pontos')}
      ...
      <footer style={styles.footer}>
        <p>&copy; 2025 GADYS. Descubra o Espírito Santo.</p>
      </footer>
    </div>
  );
};
