...
const MatoGrosso = () => {
  ...
  const images = ['/images/geral/matogrosso.jpg', '/images/geral/matogrosso1.webp'];
  ...
  const styles = {
    ...
    h2: { fontFamily: `'Georgia', serif`, fontSize: 'clamp(2rem, 4vw, 2.8rem)', color: darkMode ? '#7ecfb0' : '#1a6b4a', marginBottom: '1.5rem', fontWeight: 400 },
    pWithBorder: { fontSize: 'clamp(1rem, 2vw, 1.15rem)', lineHeight: 1.8, color: darkMode ? '#adb5bd' : '#495057', paddingLeft: '1.5rem', borderLeft: `3px solid ${darkMode ? '#2e9e6e' : '#1a6b4a'}` },
    ctaContainer: { textAlign: 'center', background: darkMode ? '#161b22' : '#f8f9fa', padding: '6rem 2rem' },
    ctaButton: { background: 'linear-gradient(45deg, #1a6b4a, #2e9e6e)', color: 'white', border: 'none', padding: '1.2rem 3.5rem', borderRadius: '50px', cursor: 'pointer', fontSize: '1.25rem', fontWeight: 'bold', transition: 'transform 0.3s ease, box-shadow 0.3s ease', boxShadow: '0 5px 20px rgba(26,107,74,0.4)', display: 'inline-block' },
      ...
      <main>
        <section style={styles.hero}>
          ...
          <div style={styles.heroContent}>
            <h1 style={styles.h1}>Mato Grosso: Berço do Pantanal</h1>
            <p style={styles.heroP}>Terra onde a Amazônia encontra o Cerrado e o Pantanal. Mato Grosso é um dos estados com maior biodiversidade do planeta, com rios cristalinos, chapadas e uma natureza que impressiona.</p>
          </div>
        </section>
        ...
        <section style={styles.featureSection} className="feature-section-animate">
          <div style={styles.featureImageContainer} className="feature-image-container">
            <img src="/images/geral/matogrosso2.webp" alt="Chapada dos Guimarães" style={styles.featureImage} className="feature-image" />
          </div>
          <div style={styles.featureText}>
            <h2 style={styles.h2}>Chapada dos Guimarães</h2>
            <p style={styles.pWithBorder}>Considerada o centro geodésico da América do Sul, a Chapada dos Guimarães encanta com cânions, cachoeiras e formações rochosas únicas. O Parque Nacional guarda o Véu de Noiva, uma das cachoeiras mais fotografadas do Brasil.</p>
          </div>
        </section>

        <section style={{ ...styles.featureSection, flexDirection: 'row-reverse' }} className="feature-section-animate">
          <div style={styles.featureImageContainer} className="feature-image-container">
            <img src="/images/geral/matogrosso-natureza.webp" alt="Pantanal Mato-grossense" style={styles.featureImage} className="feature-image" />
          </div>
          <div style={styles.featureText}>
            <h2 style={styles.h2}>Pantanal Mato-grossense</h2>
            <p style={styles.pWithBorder}>A maior planície alagável do mundo abriga onças-pintadas, capivaras, tuiuiús e mais de 650 espécies de aves. O Pantanal mato-grossense é um dos destinos de ecoturismo mais procurados do Brasil, com fazendas-hotel e safáris fotográficos.</p>
          </div>
        </section>

        <section style={styles.featureSection} className="feature-section-animate">
          <div style={styles.featureImageContainer} className="feature-image-container">
            <img src="/images/geral/matogrosso-comida.webp" alt="Gastronomia mato-grossense" style={styles.featureImage} className="feature-image" />
          </div>
          <div style={styles.featureText}>
            <h2 style={styles.h2}>Sabores do Cerrado e do Pantanal</h2>
            <p style={styles.pWithBorder}>A culinária mato-grossense é marcada pelo peixe fresco do Pantanal. O pacu assado, o pintado na telha, o arroz carreteiro e o bolo de arroz são pratos que expressam a identidade de um povo ligado à terra e aos rios.</p>
          </div>
        </section>

        <section style={styles.ctaContainer}>
          <button style={styles.ctaButton} onClick={() => navigate('/mato-grosso-pontos')}
            onMouseOver={e => { e.currentTarget.style.transform = 'scale(1.05)'; }}
            onMouseOut={e => { e.currentTarget.style.transform = 'scale(1)'; }}>
            Explore o Mato Grosso
          </button>
        </section>
      </main>
      <footer style={styles.footer}><p>&copy; 2025 GADYS. Descubra o Mato Grosso.</p></footer>
    </div>
  );
};
