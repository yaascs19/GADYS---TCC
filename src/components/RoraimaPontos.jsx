...
const config = {
  ...
  pontos: [
    ...
    { id: 'cultura-yanomami', nome: 'Terra Indígena Yanomami', cidade: 'Alto Alegre - RR', categoria: 'Lugar Paradísíaco', descricao: 'A maior terra indígena do Brasil, lar do povo Yanomami. Visitas guiadas e responsáveis permitem conhecer a cultura, o artesanato e os rituais deste povo milenar.', imagem: '/images/geral/amazonas2.jpg', rota: null },
