...
const pontos = [
  { id: 'pedra-azul-es', nome: 'Pedra Azul', cidade: 'Domingos Martins - ES', categoria: 'Lugar Paradísíaco', descricao: 'Uma das formações rochosas mais belas do Brasil, com 1.822 metros de altitude e trilhas que revelam vistas deslumbrantes da Serra Capixaba.', imagem: '/images/geral/PedraAzulES.webp', rota: '/es/pedra-azul' },
  { id: 'guarapari', nome: 'Guarapari', cidade: 'Guarapari - ES', categoria: 'Lugar Paradísíaco', descricao: 'A "Cidade Saúde" do Brasil, famosa pelas areias monazíticas com propriedades terapêuticas e praias de águas mornas e cristalinas.', imagem: '/images/geral/GuarapariES.jpg', rota: '/es/guarapari' },
