...
const config = {
  ...
  carouselImages: ['/images/geral/cata-xx.jpg', '/images/geral/cata1.jpg'],
  galeriaImages: [
    { src: '/images/geral/cata-xx.jpg', alt: 'Cataratas do Iguaçu' },
    { src: '/images/geral/cata1.jpg', alt: 'Cataratas do Iguaçu' },
    { src: '/images/geral/cata2.jpg', alt: 'Cataratas do Iguaçu' },
  ],
  secoes: {
    sobre: {
      label: 'Sobre',
