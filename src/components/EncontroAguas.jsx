...
const DADOS_FALLBACK = {
  ...
  secoes: {
    ...
    visita: {
      ...
      recomendacoes: [
        { titulo: 'Agências Confiáveis para sua Aventura', itens: [{ nome: 'Amazon Tour', nota: 4.9, contato: '(11) 4858-1141', site: 'https://amazontourmanaus.com/' }, { nome: 'Manaus Jungle Tours', nota: 4.8, contato: '(92) 99186-7133', site: 'https://www.manausjungletours.com/' }, { nome: 'Iguana Turismo', nota: 4.9, contato: '(92) 99351-3630', site: 'https://www.iguanaturismo.com.br/' }] },
        { titulo: 'Onde Recarregar as Energias', itens: [{ nome: 'Hotel Villa Amazônia', nota: 4.7, contato: '(92) 99156-5369', site: 'https://villaamazonia.com/pt/' }, { nome: 'Juma Ópera Hotel', nota: 4.3, contato: '(92) 99137-4260', site: 'https://www.jumaopera.com.br/' }, { nome: 'Blue Tree Premium Manaus', nota: 4.5, contato: '(92) 3303-2000', site: 'https://www.bluetree.com.br/hotel/blue-tree-premium-manaus/' }] },
