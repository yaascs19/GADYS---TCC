...
const MatoGrossoDoSul = () => {
  ...
  const images = ['/images/geral/ms.jpg', '/images/geral/ms1.jpg'];
  ...
  const styles = {
    ...
    h2: { fontFamily: `'Georgia', serif`, fontSize: 'clamp(2rem, 4vw, 2.8rem)', color: darkMode ? '#7ecfe0' : '#0a6b7a', marginBottom: '1.5rem', fontWeight: 400 },
    pWithBorder: { fontSize: 'clamp(1rem, 2vw, 1.15rem)', lineHeight: 1.8, color: darkMode ? '#adb5bd' : '#495057', paddingLeft: '1.5rem', borderLeft: `3px solid ${darkMode ? '#1a9eb5' : '#0a6b7a'}` },
    ctaContainer: { textAlign: 'center', background: darkMode ? '#161b22' : '#f8f9fa', padding: '6rem 2rem' },
    ctaButton: { background: 'linear-gradient(45deg, #0a6b7a, #1a9eb5)', color: 'white', border: 'none', padding: '1.2rem 3.5rem', borderRadius: '50px', cursor: 'pointer', fontSize: '1.25rem', fontWeight: 'bold', transition: 'transform 0.3s ease, box-shadow 0.3s ease', boxShadow: '0 5px 20px rgba(10,107,122,0.4)', display: 'inline-block' },
      ...
      <main>
        <section style={styles.hero}>
          ...
          <div style={styles.heroContent}>
            <h1 style={styles.h1}>Mato Grosso do Sul: Águas e Aventura</h1>
            <p style={styles.heroP}>Terra de Bonito, do Pantanal sul e das águas mais cristalinas do Brasil. O Mato Grosso do Sul é o destino do ecoturismo de excelência no coração da América do Sul.</p>
          </div>
        </section>
        ...
        <section style={styles.featureSection} className="feature-section-animate">
          <div style={styles.featureImageContainer} className="feature-image-container">
            <img src="/images/geral/ms2.jpg" alt="Bonito MS" style={styles.featureImage} className="feature-image" />
          </div>
          <div style={styles.featureText}>
            <h2 style={styles.h2}>Bonito: Capital do Ecoturismo</h2>
            <p style={styles.pWithBorder}>Bonito é o destino de ecoturismo mais premiado do Brasil. Rios de águas cristalinas como o Rio da Prata e o Sucuri, grutas com estalactites e flutuações entre peixes coloridos fazem de Bonito um paraíso único no mundo.</p>
          </div>
        </section>

        <section style={{ ...styles.featureSection, flexDirection: 'row-reverse' }} className="feature-section-animate">
          <div style={styles.featureImageContainer} className="feature-image-container">
            <img src="/images/geral/ms-monumento.jpg" alt="Campo Grande MS" style={styles.featureImage} className="feature-image" />
          </div>
          <div style={styles.featureText}>
            <h2 style={styles.h2}>Campo Grande: A Cidade Morena</h2>
            <p style={styles.pWithBorder}>A capital sul-mato-grossense é conhecida como "Cidade Morena" pela cor avermelhada de seu solo. Com museus, parques e uma vida cultural vibrante, Campo Grande é o ponto de partida para explorar o Pantanal e Bonito.</p>
          </div>
        </section>

        <section style={styles.featureSection} className="feature-section-animate">
          <div style={styles.featureImageContainer} className="feature-image-container">
            <img src="/images/geral/ms-comida.jpg" alt="Gastronomia sul-mato-grossense" style={styles.featureImage} className="feature-image" />
          </div>
          <div style={styles.featureText}>
            <h2 style={styles.h2}>Sabores do Pantanal</h2>
            <p style={styles.pWithBorder}>A culinária sul-mato-grossense é marcada pela influência paraguaia e boliviana. O chipa, o sopa paraguaia, o peixe do Pantanal e o sobá — macarrão japonês adaptado pela colônia de Okinawa em Campo Grande — são pratos únicos desta terra.</p>
          </div>
        </section>

        <section style={styles.ctaContainer}>
          <button style={styles.ctaButton} onClick={() => navigate('/ms-pontos')}
            onMouseOver={e => { e.currentTarget.style.transform = 'scale(1.05)'; }}
            onMouseOut={e => { e.currentTarget.style.transform = 'scale(1)'; }}>
            Explore o Mato Grosso do Sul
          </button>
        </section>
      </main>
      <footer style={styles.footer}><p>&copy; 2025 GADYS. Descubra o Mato Grosso do Sul.</p></footer>
    </div>
  );
};
