...
const config = {
  ...
  carouselImages: ['/images/geral/ouro preto1.jpg', '/images/geral/ouro preto2.jpg'],
  galeriaImages: [
    { src: '/images/geral/ouro preto3.webp', alt: 'Ouro Preto centro histórico' },
    { src: '/images/geral/ouro preto4.webp', alt: 'Igreja de Ouro Preto' },
    { src: '/images/geral/ouro preto5.jpg', alt: 'Casarões coloniais' },
  ],
  secoes: {
    sobre: {
      label: 'Sobre',
      ...
      imagem: '/images/geral/ouro preto3.webp',
      alt: 'Vista panorâmica de Ouro Preto',
      lista: [
        'UNESCO: Patrimônio Mundial desde 1980.',
        'Altitude: 1.179 metros acima do nível do mar.',
        'Destaque: Igreja de São Francisco de Assis, obra-prima de Aleijadinho.',
      ],
    },
    experiencias: {
      label: 'Experiências',
      ...
      imagem: '/images/geral/ouro preto4.webp',
    ...
    visita: {
      ...
      imagem: '/images/geral/ouro preto5.jpg',
      ...
      recomendacoes: [
        {
          titulo: 'Onde Comer',
          itens: [
            { nome: 'Restaurante Chafariz', nota: 4.8, contato: '(31) 3551-2828', site: 'https://www.instagram.com/' },
            { nome: 'Casa do Ouvidor', nota: 4.7, contato: '(31) 3551-3141', site: 'https://www.instagram.com/' },
          ],
        },
        {
          titulo: 'Onde Ficar',
          itens: [
            { nome: 'Pousada do Mondego', nota: 4.8, contato: '(31) 3551-2040', site: 'https://www.pousadadomondego.com.br/' },
            { nome: 'Hotel Solar do Rosário', nota: 4.7, contato: '(31) 3551-5200', site: 'https://www.instagram.com/' },
          ],
        },
      ],
    },
