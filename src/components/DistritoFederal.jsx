...
const DistritoFederal = () => {
  ...
  const styles = {
    ...
    h2: { fontFamily: `'Georgia', serif`, fontSize: 'clamp(2rem, 4vw, 2.8rem)', color: darkMode ? '#85c1e9' : '#1a5276', marginBottom: '1.5rem', fontWeight: 400 },
    pWithBorder: { fontSize: 'clamp(1rem, 2vw, 1.15rem)', lineHeight: 1.8, color: darkMode ? '#adb5bd' : '#495057', paddingLeft: '1.5rem', borderLeft: `3px solid ${darkMode ? '#2980b9' : '#1a5276'}` },
    ctaContainer: { textAlign: 'center', background: darkMode ? '#161b22' : '#f8f9fa', padding: '6rem 2rem' },
    ctaButton: { background: 'linear-gradient(45deg, #1a5276, #154360)', color: 'white', border: 'none', padding: '1.2rem 3.5rem', borderRadius: '50px', cursor: 'pointer', fontSize: '1.25rem', fontWeight: 'bold', transition: 'transform 0.3s ease, box-shadow 0.3s ease', boxShadow: '0 5px 20px rgba(26,82,118,0.4)', display: 'inline-block' },
      ...
      <main>
        ...
        <section style={{ ...styles.featureSection, flexDirection: 'row-reverse' }} className="feature-section-animate">
          ...
          <div style={styles.featureText}>
            ...
            <p style={styles.pWithBorder}>Além da arquitetura, o DF e seus arredores guardam a beleza do cerrado brasileiro. A Chapada dos Veadeiros, a apenas 230 km, é Patrimônio Natural da Humanidade com cachoeiras, trilhas e uma biodiversidade única.</p>
          </div>
        </section>
