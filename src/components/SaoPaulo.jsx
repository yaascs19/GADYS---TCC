    ...
    <div style={{
      ...
      <main style={{
        ...
        <section style={{
          textAlign: 'center',
          padding: '8rem 0 6rem',
          background: `url('/sp.jpg') center/cover no-repeat, ${darkMode ? 'linear-gradient(135deg, rgba(33, 150, 243, 0.8) 0%, rgba(100, 181, 246, 0.7) 100%)' : 'linear-gradient(135deg, rgba(255,255,255,0.9) 0%, rgba(255,255,255,0.8) 100%)'}`,
            ...
            {(secaoAtiva === 'lugares' ? [
              ...
              onClick={() => {
                if (categoria.key === 'monumentos') {
                  window.location.href = '/monumentos-sao-paulo'
                } else {
