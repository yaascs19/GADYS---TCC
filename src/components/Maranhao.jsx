...
const Maranhao = () => {
  ...
  const images = [
    '/images/geral/maranhao.webp',
    '/images/geral/maranhao1.jpg',
  ];
  ...
  const styles = {
    ...
    h2: { fontFamily: `'Georgia', serif`, fontSize: 'clamp(2rem, 4vw, 2.8rem)', color: darkMode ? '#7ec8e3' : '#0a5c7a', marginBottom: '1.5rem', fontWeight: 400 },
    pWithBorder: { fontSize: 'clamp(1rem, 2vw, 1.15rem)', lineHeight: 1.8, color: darkMode ? '#adb5bd' : '#495057', paddingLeft: '1.5rem', borderLeft: `3px solid ${darkMode ? '#1a8fb5' : '#0a5c7a'}` },
    ctaContainer: { textAlign: 'center', background: darkMode ? '#161b22' : '#f8f9fa', padding: '6rem 2rem' },
    ctaButton: { background: 'linear-gradient(45deg, #0a5c7a, #1a8fb5)', color: 'white', border: 'none', padding: '1.2rem 3.5rem', borderRadius: '50px', cursor: 'pointer', fontSize: '1.25rem', fontWeight: 'bold', transition: 'transform 0.3s ease, box-shadow 0.3s ease', boxShadow: '0 5px 20px rgba(10,92,122,0.4)', display: 'inline-block' },
  ...
  return (
    <div style={styles.page}>
      ...
      <main>
        <section style={styles.hero}>
          ...
          <div style={styles.heroContent}>
            <h1 style={styles.h1}>Maranhão: Entre o Céu e a Areia</h1>
            <p style={styles.heroP}>Terra dos Lençóis Maranhenses, do bumba-meu-boi e do Delta do Parnaíba. O Maranhão é onde o deserto encontra o mar e a cultura pulsa em cada esquina de São Luís.</p>
          </div>
        </section>
        ...
        <section style={styles.featureSection} className="feature-section-animate">
          <div style={styles.featureImageContainer} className="feature-image-container">
            <img src="/images/geral/maranhao2.jpg" alt="Lençóis Maranhenses" style={styles.featureImage} className="feature-image" />
          </div>
          <div style={styles.featureText}>
            <h2 style={styles.h2}>Lençóis Maranhenses</h2>
            <p style={styles.pWithBorder}>Um dos fenômenos naturais mais únicos do planeta: dunas de areia branca que se estendem por 155 mil hectares, pontilhadas por lagoas de água doce cristalina formadas pelas chuvas. Um paraíso que desafia qualquer definição.</p>
          </div>
        </section>

        <section style={{ ...styles.featureSection, flexDirection: 'row-reverse' }} className="feature-section-animate">
          <div style={styles.featureImageContainer} className="feature-image-container">
            <img src="/images/geral/maranhao-monumento.jpeg" alt="São Luís histórica" style={styles.featureImage} className="feature-image" />
          </div>
          <div style={styles.featureText}>
            <h2 style={styles.h2}>São Luís: Patrimônio da Humanidade</h2>
            <p style={styles.pWithBorder}>O centro histórico de São Luís, tombado pela UNESCO, é um dos maiores conjuntos de arquitetura colonial portuguesa das Américas. Azulejos portugueses, sobrados coloridos e igrejas barrocas contam séculos de história nas ruas da Ilha do Amor.</p>
          </div>
        </section>

        <section style={styles.featureSection} className="feature-section-animate">
          <div style={styles.featureImageContainer} className="feature-image-container">
            <img src="/images/geral/maranhao-comida.webp" alt="Gastronomia maranhense" style={styles.featureImage} className="feature-image" />
          </div>
          <div style={styles.featureText}>
            <h2 style={styles.h2}>Sabores do Maranhão</h2>
            <p style={styles.pWithBorder}>A culinária maranhense é uma das mais originais do Brasil. O arroz de cuxá, a torta de camarão, o caranguejo e o famoso arroz de leite são expressões de uma gastronomia que mistura influências africanas, indígenas e portuguesas em cada prato.</p>
          </div>
        </section>
        ...
        <section style={styles.ctaContainer}>
          <button
            ...
            onClick={() => navigate('/maranhao-pontos')}
            onMouseOver={(e) => { e.currentTarget.style.transform = 'scale(1.05)'; e.currentTarget.style.boxShadow = '0 8px 25px rgba(10,92,122,0.6)'; }}
            onMouseOut={(e) => { e.currentTarget.style.transform = 'scale(1)'; e.currentTarget.style.boxShadow = '0 5px 20px rgba(10,92,122,0.4)'; }}
          >
            Explore o Maranhão
          </button>
        </section>
      ...
      <footer style={styles.footer}>
        <p>&copy; 2025 GADYS. Descubra o Maranhão.</p>
      </footer>
    </div>
  );
};
