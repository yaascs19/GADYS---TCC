...
const Bahia = () => {
  ...
  const styles = {
    ...
    h2: { fontFamily: `'Georgia', serif`, fontSize: 'clamp(2rem, 4vw, 2.8rem)', color: darkMode ? '#e8a045' : '#c0392b', marginBottom: '1.5rem', fontWeight: 400 },
    pWithBorder: { fontSize: 'clamp(1rem, 2vw, 1.15rem)', lineHeight: 1.8, color: darkMode ? '#adb5bd' : '#495057', paddingLeft: '1.5rem', borderLeft: `3px solid ${darkMode ? '#c0392b' : '#922b21'}` },
    ctaContainer: { textAlign: 'center', background: darkMode ? '#161b22' : '#f8f9fa', padding: '6rem 2rem' },
    ctaButton: { background: 'linear-gradient(45deg, #c0392b, #922b21)', color: 'white', border: 'none', padding: '1.2rem 3.5rem', borderRadius: '50px', cursor: 'pointer', fontSize: '1.25rem', fontWeight: 'bold', transition: 'transform 0.3s ease, box-shadow 0.3s ease', boxShadow: '0 5px 20px rgba(192,57,43,0.4)', display: 'inline-block' },
      ...
      <main>
        <section style={styles.hero}>
          ...
          <div style={styles.heroContent}>
            <h1 style={styles.h1}>Bahia: Berço da Brasilidade</h1>
            <p style={styles.heroP}>Terra de axé, fé e beleza sem igual. A Bahia pulsa com a força da cultura afro-brasileira, praias paradisíacas e uma história que moldou o Brasil.</p>
          </div>
        </section>
        ...
        <section style={styles.featureSection} className="feature-section-animate">
          ...
          <div style={styles.featureText}>
            ...
            <p style={styles.pWithBorder}>A Bahia é o coração da cultura afro-brasileira. Do candomblé ao axé, da capoeira ao samba de roda, cada rua do Pelourinho conta histórias de resistência, fé e celebração que ecoam por todo o Brasil.</p>
          </div>
        </section>
        ...
        <section style={{ ...styles.featureSection, flexDirection: 'row-reverse' }} className="feature-section-animate">
          ...
          <div style={styles.featureText}>
            ...
            <p style={styles.pWithBorder}>A culinária baiana é uma das mais ricas do Brasil. O acarajé frito no azeite de dendê, a moqueca fumegante, o vatapá cremoso e o caruru são expressões de uma gastronomia que mistura África, Portugal e Brasil em cada garfada.</p>
          </div>
        </section>
        ...
        <section style={styles.featureSection} className="feature-section-animate">
          ...
          <div style={styles.featureText}>
            ...
            <p style={styles.pWithBorder}>Da Chapada Diamantina com suas cachoeiras e grutas à Costa do Descobrimento com praias intocadas, a Bahia oferece uma natureza de tirar o fôlego. São mais de 1.100 km de litoral e paisagens que vão do sertão ao mar.</p>
          </div>
        </section>
