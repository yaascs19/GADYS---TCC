...
const config = {
  ...
  carouselImages: ['/images/monumentos/jus.jpeg', '/images/monumentos/pala.jpeg', '/images/monumentos/zero.jpeg'],
  galeriaImages: [
    { src: '/images/monumentos/jus.jpeg', alt: 'Congresso Nacional' },
    { src: '/images/monumentos/pala.jpeg', alt: 'Esplanada dos Ministérios' },
    { src: '/images/monumentos/zero.jpeg', alt: 'Brasília' },
    { src: '/images/monumentos/independencia.webp', alt: 'Monumento' },
  ],
  tema: {
