...
const Alagoas = () => {
  ...
  const styles = {
    ...
    pWithBorder: {
      ...
      paddingLeft: '1.5rem',
      borderLeft: `3px solid ${darkMode ? '#006994' : '#005f7f'}`,
    },
    ctaContainer: {
      textAlign: 'center',
    ...
    ctaButton: {
      background: 'linear-gradient(45deg, #006994, #005f7f)',
      color: 'white',
      border: 'none',
      ...
      boxShadow: '0 5px 20px rgba(0, 95, 127, 0.4)',
      ...
      <main>
        <section style={styles.hero}>
          ...
          <div style={styles.heroContent}>
            <h1 style={styles.h1}>Alagoas: O Paraíso das Águas</h1>
            <p style={styles.heroP}>Um estado brasileiro do Nordeste, famoso por suas lagoas cristalinas, praias de águas mornas e a hospitalidade calorosa de seu povo que encanta visitantes do mundo inteiro.</p>
          </div>
        </section>
        ...
        <section style={styles.featureSection} className="feature-section-animate">
          ...
          <div style={styles.featureText}>
            ...
            <p style={styles.pWithBorder}>A cultura alagoana é vibrante e singular. Do frevo ao xaxado, das festas juninas ao artesanato em renda filé, das tradições indígenas ao folclore ribeirinho, Alagoas celebra sua identidade com orgulho e alegria.</p>
          </div>
        </section>
        ...
        <section style={{ ...styles.featureSection, flexDirection: 'row-reverse' }} className="feature-section-animate">
          ...
          <div style={styles.featureText}>
            ...
            <p style={styles.pWithBorder}>A culinária alagoana é uma festa para o paladar. Da moqueca de sururu ao sarapatel, do surubim assado ao mungunzá, cada prato carrega a alma de um povo que transforma ingredientes simples em experiências gastronômicas inesquecíveis.</p>
          </div>
        </section>
        ...
        <section style={styles.featureSection} className="feature-section-animate">
          ...
          <div style={styles.featureText}>
            ...
            <p style={styles.pWithBorder}>Em Alagoas, a natureza é deslumbrante. Das águas esverdeadas de Maragogi às lagoas de Marechal Deodoro, dos recifes de corais da Costa dos Corais às praias selvagens de Barra de São Miguel, cada paisagem é uma obra-prima da natureza.</p>
          </div>
        </section>
        ...
        <section style={styles.ctaContainer}>
          <button
            ...
            onClick={() => navigate('/alagoas-pontos')}
