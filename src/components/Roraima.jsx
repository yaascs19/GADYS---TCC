  ...
  return (
    <div style={styles.page}>
      ...
      <main>
        <section style={styles.hero}>
          ...
          <div style={styles.heroContent}>
            <h1 style={styles.h1}>Roraima: O Teto do Brasil</h1>
            <p style={styles.heroP}>O estado mais ao norte do Brasil, terra dos tepuis, do Monte Roraima e da maior savana amazônica do mundo.</p>
          </div>
        </section>
        ...
        <section style={styles.featureSection} className="feature-section-animate">
          ...
          <div style={styles.featureText}>
            ...
            <p style={styles.pWithBorder}>Roraima é o lar dos tepuis, formações rochosas tabulares que se erguem abruptamente da savana. O Monte Roraima, com 2.875 metros de altitude, é o ponto mais alto do Brasil e uma das formações geológicas mais antigas do planeta, com mais de 1,8 bilhão de anos.</p>
          </div>
        </section>
        ...
        <section style={{...styles.featureSection, flexDirection: 'row-reverse'}} className="feature-section-animate">
          ...
          <div style={styles.featureText}>
            ...
            <p style={styles.pWithBorder}>O Lavrado de Roraima é a maior savana amazônica do mundo, um ecossistema único que contrasta com a floresta densa. Com campos abertos, buritizais e lagoas sazonais, abriga espécies endêmicas que não existem em nenhum outro lugar do planeta.</p>
          </div>
        </section>
        ...
        <section style={styles.featureSection} className="feature-section-animate">
          ...
          <div style={styles.featureText}>
            ...
            <p style={styles.pWithBorder}>Roraima tem a maior proporção de população indígena entre os estados brasileiros. Os Yanomami, Macuxi e Wapichana habitam o estado há milênios. Boa Vista é a única capital brasileira ao norte do Equador.</p>
          </div>
        </section>

        <section style={styles.ctaContainer}>
          <button style={styles.ctaButton} onClick={() => navigate('/roraima-pontos')}
      ...
      <footer style={styles.footer}>
        <p>&copy; 2025 GADYS. Descubra Roraima.</p>
      </footer>
    </div>
  );
};
