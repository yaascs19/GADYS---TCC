...
const config = {
  ...
  pontos: [
    ...
    { id: 'memorial-chico-mendes', nome: 'Memorial Chico Mendes', cidade: 'Xapuri - AC', categoria: 'Monumentos', descricao: 'Homenagem ao seringueiro e ambientalista Chico Mendes, assassinado em 1988. O memorial preserva a casa onde viveu e lutou pela floresta.', imagem: '/images/geral/ac-memorial.jpg', rota: '/acre/memorial-chico-mendes' },
    { id: 'reserva-extrativista-chico-mendes', nome: 'Reserva Extrativista Chico Mendes', cidade: 'Xapuri - AC', categoria: 'Lugar Paradísíaco', descricao: 'Criada em homenagem ao ambientalista, a reserva protege comunidades de seringueiros e uma vasta área de floresta amazônica preservada.', imagem: '/images/geral/ac-reserva.jpg', rota: '/acre/reserva-extrativista-chico-mendes' },
