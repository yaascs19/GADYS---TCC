...
const config = {
  ...
  pontos: [
    ...
    { id: 'parque-zoobotanico', nome: 'Parque Zoobotânico', cidade: 'Rio Branco - AC', categoria: 'Lugar Paradísíaco', descricao: 'Um dos maiores parques urbanos da Amazônia, com trilhas ecológicas, animais silvestres e uma coleção botânica impressionante.', imagem: '/images/geral/ac-parquezoo.jpg', rota: null },
