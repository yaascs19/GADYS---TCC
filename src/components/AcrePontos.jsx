...
const config = {
  ...
  pontos: [
    ...
    { id: 'parque-zoobotanico', nome: 'Parque Zoobotânico de Rio Branco', cidade: 'Rio Branco', categoria: 'Lugar Paradísíaco', descricao: 'Um dos maiores parques urbanos da Amazônia, com zoológico, trilhas ecológicas e jardim botânico no campus da UFAC.' },
  ],
};
