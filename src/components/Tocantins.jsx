  ...
  return (
    <div style={styles.page}>
      ...
      <main>
        <section style={styles.hero}>
          ...
          <div style={styles.heroContent}>
            <h1 style={styles.h1}>Tocantins: O Coração do Brasil</h1>
            <p style={styles.heroP}>O estado mais jovem do Brasil, onde o Cerrado encontra a Amazônia e o Rio Tocantins cria paisagens de rara beleza.</p>
          </div>
        </section>
        ...
        <section style={styles.featureSection} className="feature-section-animate">
          ...
          <div style={styles.featureText}>
            ...
            <p style={styles.pWithBorder}>O Jalapão é um dos destinos ecoturísticos mais deslumbrantes do Brasil. Com dunas de areia dourada, fervedouros de água cristalina, cachoeiras e serras, o parque estadual oferece uma experiência única de contato com a natureza selvagem do Cerrado tocantinense.</p>
          </div>
        </section>
        ...
        <section style={{...styles.featureSection, flexDirection: 'row-reverse'}} className="feature-section-animate">
          ...
          <div style={styles.featureText}>
            ...
            <p style={styles.pWithBorder}>O Rio Tocantins é a alma do estado. Durante a estação seca, suas margens revelam praias fluviais de areia branca que atraem turistas de todo o Brasil. Palmas, a capital planejada, foi construída às margens do Lago de Palmas.</p>
          </div>
        </section>
        ...
        <section style={styles.featureSection} className="feature-section-animate">
          ...
          <div style={styles.featureText}>
            ...
            <p style={styles.pWithBorder}>O Tocantins é um estado jovem, criado em 1988, mas com uma cultura rica e diversificada. A Festa do Capim Dourado, o artesanato com a fibra dourada do Jalapão, é reconhecida mundialmente como símbolo da identidade tocantinense.</p>
          </div>
        </section>

        <section style={styles.ctaContainer}>
          <button style={styles.ctaButton} onClick={() => navigate('/tocantins-pontos')}
      ...
      <footer style={styles.footer}>
        <p>&copy; 2025 GADYS. Descubra o Tocantins.</p>
      </footer>
    </div>
  );
};
