  ...
  return (
    <div style={styles.page}>
      ...
      <main>
        <section style={styles.hero}>
          ...
          <div style={styles.heroContent}>
            <h1 style={styles.h1}>Amapá: Entre o Rio e o Mar</h1>
            <p style={styles.heroP}>O estado onde a Amazônia encontra o Atlântico, com manguezais, praias selvagens e uma biodiversidade extraordinária.</p>
          </div>
        </section>
        ...
        <section style={styles.featureSection} className="feature-section-animate">
          ...
          <div style={styles.featureText}>
            ...
            <p style={styles.pWithBorder}>O Amapá possui mais de 70% do seu território protegido por unidades de conservação, tornando-o um dos estados mais preservados do Brasil. A Área de Proteção Ambiental do Rio Curiaú e o Parque Nacional do Cabo Orange são alguns dos tesouros naturais do estado.</p>
          </div>
        </section>
        ...
        <section style={{...styles.featureSection, flexDirection: 'row-reverse'}} className="feature-section-animate">
          ...
          <div style={styles.featureText}>
            ...
            <p style={styles.pWithBorder}>A cultura amapaense é profundamente ligada aos rios e ao mar. O Marabaixo, dança afro-brasileira tombada como patrimônio imaterial, e o Batuque são expressões culturais que resistem ao tempo.</p>
          </div>
        </section>
        ...
        <section style={styles.featureSection} className="feature-section-animate">
          ...
          <div style={styles.featureText}>
            ...
            <p style={styles.pWithBorder}>Macapá é uma das poucas cidades do mundo cortadas pela linha do Equador. A Fortaleza de São José de Macapá, construída no século XVIII, é o maior monumento histórico da Amazônia brasileira.</p>
          </div>
        </section>

        <section style={styles.ctaContainer}>
          <button style={styles.ctaButton} onClick={() => navigate('/amapa-pontos')}
      ...
      <footer style={styles.footer}>
        <p>&copy; 2025 GADYS. Descubra o Amapá.</p>
      </footer>
    </div>
  );
};
