export const destinosAmazonasData = [
  {
    id: 1,
    name: 'Encontro das Águas',
    category: 'Lugar Paradisíaco',
    location: 'Manaus',
    image: '/images/geral/eda-am.jpeg',
    description: 'O fenômeno natural onde as águas escuras do Rio Negro e as águas barrentas do Rio Solimões correm lado a lado sem se misturar por quilômetros.'
  },
  {
    id: 2,
    ...
    category: 'Monumento',
    location: 'Manaus',
    image: '/images/geral/ta-am.jpg',
    description: 'Uma deslumbrante casa de ópera do século XIX, símbolo da riqueza do ciclo da borracha e um marco cultural da região.'
  },
  {
    id: 3,
